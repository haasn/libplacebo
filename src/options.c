...
const struct pl_opt_t pl_option_list[] = {
    ...
    OPT_FLOAT("knee_minimum", "Tone mapping knee point minimum", color_map_params.tone_constants.knee_minimum, .min = 1e-6f, .max = 0.5f - 1e-6f),
    OPT_FLOAT("knee_maximum", "Tone mapping knee point maximum", color_map_params.tone_constants.knee_maximum, .min = 0.5f + 1e-6f, .max = 1.0f - 1e-6f),
    ...
    OPT_FLOAT("reinhard_contrast", "Reinhard contrast", color_map_params.tone_constants.reinhard_contrast, .min = 1e-6f, .max = 1.0f - 1e-6f),
    OPT_FLOAT("linear_knee", "Tone mapping linear knee point", color_map_params.tone_constants.linear_knee, .min = 1e-6f, .max = 1.0f - 1e-6f),
    OPT_FLOAT("exposure", "Tone mapping linear exposure", color_map_params.tone_constants.exposure, .min = 1e-6f, .max = 10.0f),
