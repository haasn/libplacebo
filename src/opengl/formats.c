...
const struct gl_format gl_formats[] = {
    ...
    {GL_R8,             C_R,     T_U8,  FMT("r8",       8, UNORM), F_VF | F_CF | F_GL3 | F_GL2F | F_ES3},
    {GL_RG8,            C_RG,    T_U8,  FMT("rg8",      8, UNORM), F_VF | F_CF | F_GL3 | F_GL2F | F_ES3},
    {GL_RGB8,           C_RGB,   T_U8,  FMT("rgb8",     8, UNORM), F_VF | F_CF | F_GL3 | F_GL2F | F_ES3},
    {GL_RGBA8,          C_RGBA,  T_U8,  FMT("rgba8",    8, UNORM), F_VF | F_CF | F_GL3 | F_GL2F | F_ES3},
    {GL_R16,            C_R,     T_U16, FMT("r16",     16, UNORM), F_VF | F_CF | F_GL3 | F_GL2F | F_EXT16},
    {GL_RG16,           C_RG,    T_U16, FMT("rg16",    16, UNORM), F_VF | F_CF | F_GL3 | F_GL2F | F_EXT16},
    {GL_RGB16,          C_RGB,   T_U16, FMT("rgb16",   16, UNORM), F_VF | F_CF | F_GL3 | F_GL2F},
    {GL_RGBA16,         C_RGBA,  T_U16, FMT("rgba16",  16, UNORM), F_VF | F_CF | F_GL3 | F_GL2F | F_EXT16},

    // Specifically not color-renderable.
    {GL_RGB16,          C_RGB,   T_U16, FMT("rgb16",   16, UNORM), F_VF | F_TF | F_EXT16},

    // GL2 legacy formats. Ignores possibly present FBO extensions (no CF flag set)
    {GL_RGB8,           C_RGB,   T_U8,  FMT("rgb8",     8, UNORM), F_VF | F_TF | F_GL2},
    {GL_RGBA8,          C_RGBA,  T_U8,  FMT("rgba8",    8, UNORM), F_VF | F_TF | F_GL2},
    {GL_RGB16,          C_RGB,   T_U16, FMT("rgb16",   16, UNORM), F_VF | F_TF | F_GL2},
    {GL_RGBA16,         C_RGBA,  T_U16, FMT("rgba16",  16, UNORM), F_VF | F_TF | F_GL2},

    // ES2 legacy
    {GL_RGB,            C_RGB,   T_U8,  FMT("rgb",      8, UNORM), F_TF | F_ES2},
    {GL_RGBA,           C_RGBA,  T_U8,  FMT("rgba",     8, UNORM), F_TF | F_ES2},

    // Non-normalized integer formats.
    // Follows ES 3.0 as to which are color-renderable.
    {GL_R8UI,           C_RI,    T_U8,  FMT("r8u",      8, UINT),  F_VF | F_GL3 | F_ES3 | F_CR},
    {GL_RG8UI,          C_RGI,   T_U8,  FMT("rg8u",     8, UINT),  F_VF | F_GL3 | F_ES3 | F_CR},
    {GL_RGB8UI,         C_RGBI,  T_U8,  FMT("rgb8u",    8, UINT),  F_VF | F_GL3 | F_ES3},
    {GL_RGBA8UI,        C_RGBAI, T_U8,  FMT("rgba8u",   8, UINT),  F_VF | F_GL3 | F_ES3 | F_CR},
    {GL_R16UI,          C_RI,    T_U16, FMT("r16u",    16, UINT),  F_VF | F_GL3 | F_ES3 | F_CR},
    {GL_RG16UI,         C_RGI,   T_U16, FMT("rg16u",   16, UINT),  F_VF | F_GL3 | F_ES3 | F_CR},
    {GL_RGB16UI,        C_RGBI,  T_U16, FMT("rgb16u",  16, UINT),  F_VF | F_GL3 | F_ES3},
    {GL_RGBA16UI,       C_RGBAI, T_U16, FMT("rgba16u", 16, UINT),  F_VF | F_GL3 | F_ES3 | F_CR},
    ...
    */
    ...
    {GL_R16F,           C_R,     T_FLT, FMT("r16f",    16, FLOAT), F_CF | F_GL3 | F_GL2F},
    {GL_RG16F,          C_RG,    T_FLT, FMT("rg16f",   16, FLOAT), F_CF | F_GL3 | F_GL2F},
    {GL_RGB16F,         C_RGB,   T_FLT, FMT("rgb16f",  16, FLOAT), F_CF | F_GL3 | F_GL2F},
    {GL_RGBA16F,        C_RGBA,  T_FLT, FMT("rgba16f", 16, FLOAT), F_CF | F_GL3 | F_GL2F},
    {GL_R32F,           C_R,     T_FLT, FMT("r32f",    32, FLOAT), F_VF | F_CF | F_GL3 | F_GL2F},
    {GL_RG32F,          C_RG,    T_FLT, FMT("rg32f",   32, FLOAT), F_VF | F_CF | F_GL3 | F_GL2F},
    {GL_RGB32F,         C_RGB,   T_FLT, FMT("rgb32f",  32, FLOAT), F_VF | F_CF | F_GL3 | F_GL2F},
    {GL_RGBA32F,        C_RGBA,  T_FLT, FMT("rgba32f", 32, FLOAT), F_VF | F_CF | F_GL3 | F_GL2F},
    ...
    {GL_R16F,           C_R,     T_FLT, FMT("r16f",    16, FLOAT), F_CF | F_ES32 | F_EXTF16},
    {GL_RG16F,          C_RG,    T_FLT, FMT("rg16f",   16, FLOAT), F_CF | F_ES32 | F_EXTF16},
    {GL_RGB16F,         C_RGB,   T_FLT, FMT("rgb16f",  16, FLOAT), F_TF | F_ES32 | F_EXTF16},
    {GL_RGBA16F,        C_RGBA,  T_FLT, FMT("rgba16f", 16, FLOAT), F_CF | F_ES32 | F_EXTF16},

    // On ES3.0+, 16 bit floats are texture-filterable.
    // Don't bother with 32 bit floats; they exist but are neither CR nor TF.
    {GL_R16F,           C_R,     T_FLT, FMT("r16f",    16, FLOAT), F_TF | F_ES3},
    {GL_RG16F,          C_RG,    T_FLT, FMT("rg16f",   16, FLOAT), F_TF | F_ES3},
    {GL_RGB16F,         C_RGB,   T_FLT, FMT("rgb16f",  16, FLOAT), F_TF | F_ES3},
    {GL_RGBA16F,        C_RGBA,  T_FLT, FMT("rgba16f", 16, FLOAT), F_TF | F_ES3},
