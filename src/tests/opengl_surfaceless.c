...
int main()
{
    ...
    struct {
        ...
        { EGL_OPENGL_API,       EGL_OPENGL_BIT,     4, 3, 430, EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT },
        { EGL_OPENGL_API,       EGL_OPENGL_BIT,     4, 2, 420, EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT },
        { EGL_OPENGL_API,       EGL_OPENGL_BIT,     4, 1, 410, EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT },
